    ...
    return (
        <>
            <button onClick={openMenu}>
                <div class="rounded rounded-flex items-center space-x-4 bg-gray-100 py-2 px-2 hover:shadow-lg">
            ...
            <div className={`relative min-h-full bg-gray-100 flex items-center justify-center backdrop-blur-lg z-50 ${!isOpen ? "hidden" : ""}`}>
                <div class={` bg-indigo-100 flex items-center justify-center backdrop-blur-lg  rounded-lg shadow-lg`}>
                    <div class="flex flex-col items-center py-4">
                        <img src="https://cdn3d.iconscout.com/3d/premium/thumb/work-from-home-3971986-3287021.png" alt="logo" class="h-16 w-auto ml-4 mb-4 rounded-full shadow-lg" />
